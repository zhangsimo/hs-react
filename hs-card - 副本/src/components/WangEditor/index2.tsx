...
class App extends Component<IProps, IState> {
  ...
  render() {
    ...
    return (
      <div>
        <div ref="editorElem" {...this.props.tool}></div>
        <div ref="editorElembody" {...this.props.body}></div>
      </div>
    )
  }
  componentDidMount() {
  ...
  async editorInit() {
    ...
    const editorElembody = this.refs.editorElembody
    const editor = new E(elem, editorElembody)
