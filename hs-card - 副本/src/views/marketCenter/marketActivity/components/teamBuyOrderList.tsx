...
const PageRulesSet: React.FC<IProps> = props => {
    ...
    const [teamBuyId, setTeamBuyId] = useState<any>('')
    ...
    const getTableData = (tableParams, params) =>
        api.getTeamBuyOrder({ ...api.formatParams(tableParams, { ...params, teamBuyId: teamBuyId, activityId: props.activityId }) }).then(res => ({
            list: res.data.items,
            ...
            <ToolsBar visible={false}>
                <Form form={form} layout="inline">
                    ...
                    <Form.Item name="customerName" label="买家姓名">
                        <Input placeholder="请输入买家姓名" style={{ width: '130px' }} allowClear></Input>
                    </Form.Item>
                    <Form.Item name="mobile" label="手机号">
                        <Input placeholder="请输入手机号" style={{ width: '130px' }} allowClear></Input>
                    </Form.Item>
                    <Form.Item name="carNo" label="车牌号">
                        <Input placeholder="请输入车牌" style={{ width: '120px' }} allowClear></Input>
                    </Form.Item>
