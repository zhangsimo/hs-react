...
const User = () => {
  ...
  return (
    <div>
      ...
      <div className="flex block appConfig">
        <div style={{ background: '#fff', marginRight: '15px', width: '200px' }}>
          <ul>
            <li>
              <Link to="/vipMember/list">角色管理</Link>
            </li>
            <li>
              <Link to="/vipMember/list">用户管理</Link>
            </li>
            <li>
              <Link to="/vipMember/list">菜单管理</Link>
            </li>
          </ul>
        </div>
        <Table
